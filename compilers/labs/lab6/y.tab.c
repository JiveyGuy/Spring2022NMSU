...
static const char *const yytname[] =
{
  ...
  "T_EXTERN", "T_FALSE", "T_FOR", "T_FUNC", "T_GEQ", "T_GT", "T_ID",
  "T_IF", "T_INTCONSTANT", "T_INTTYPE", "T_LEFTSHT_IFT", "T_LEQ", "T_NEQ",
  "T_NULL", "T_OR", "T_PACKAGE", "T_RETURN", "T_RIGHTSHT_IFT",
